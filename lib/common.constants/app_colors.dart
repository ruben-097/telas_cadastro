...
class AppColors {
  AppColors._();
  static const Color backgroundColor = Color(0xFF01071A);
  static const Color primaryColor = Color(0xFFF59313);
  static const Color whiteColor = Color(0xFFFFFFFF);
  static const Color secondColor = Color(0xFF1A203B);
  static const Color pinkColor = Color(0xFFF35872);
